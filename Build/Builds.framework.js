...
var ASM_CONSTS = {
  2522028: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2522083: function($0) {performance.now = function() { return $0; };},  
 2522131: function($0) {performance.now = function() { return $0; };},  
 2522179: function() {performance.now = Module['emscripten_get_now_backup'];},  
 2522234: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2522295: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2522359: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  var adBlock = {fakeAdBannerIds:["AdHeader","AdContainer","AD_Top","homead","ad-lead"],initialize:function () {
  ...
  var webApplication = {initialize:function (onInBackgroundChangeCallbackPtr) {
  ...
  function _WebApplicationInitialize(onInBackgroundChangeCallbackPtr) {
...
var asmLibraryArg = {
  "AdBlockInitialize": _AdBlockInitialize,
  ...
  "WebApplicationInitialize": _WebApplicationInitialize,
...
unexportedRuntimeFunction('device', false);
unexportedRuntimeFunction('device__user', false);
unexportedRuntimeFunction('webApplication', false);
unexportedRuntimeFunction('webApplication__user', false);
unexportedRuntimeFunction('adBlock', false);
unexportedRuntimeFunction('adBlock__user', false);
unexportedRuntimeFunction('yandexMetrica', false);
unexportedRuntimeFunction('yandexMetrica__user', false);
unexportedRuntimeFunction('vkGames', false);
unexportedRuntimeFunction('vkGames__user', false);
